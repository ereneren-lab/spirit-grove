...
if node -e "require.resolve('playwright')" 2>/dev/null; then
  ...
  pw landscape_panel_test.js
  pw gate_test.js
  pw opening_test.js
  pw wake_tile_test.js
  pw text_quality_test.js
  pw lord_route_test.js
  pw goal_reach_test.js
  pw held_effect_test.js
  pw movecat_test.js
  pw hero_sheet_test.js
  pw origin_test.js
  pw origin_npc_test.js
  pw onboarding_test.js
  pw pace_test.js
  pw early_wild_test.js
  pw trainer_ramp_test.js
  ...
  pw duo_trainers_test.js
  pw duo_rematch_test.js
  pw duo_reward_test.js
  ...
  pw steel_line_test.js
  pw mantis_line_test.js
  pw ghost_line_test.js
  pw seer_line_test.js
  ...
  pw terrain_art_test.js
  pw save_slot_test.js
  pw save_roundtrip_test.js
  pw mem_leak_test.js
  pw fly_test.js
  pw route_test.js
else
