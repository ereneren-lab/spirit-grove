...
const ABILITY_KO={blaze:"맹화",torrent:"급류",overgrow:"신록",static:"정전기",intimidate:"위협",sturdy:"옹골참",thickfat:"두꺼운지방",guts:"근성",levitate:"부유",poisonpoint:"독가시",icebody:"얼음몸",flamebody:"불꽃몸",roughskin:"까칠한피부",swiftswim:"쓸비늘",chlorophyll:"엽록소",insomnia:"불면",immunity:"면역",waterveil:"수의베일",sniper:"스나이퍼",naturalcure:"자연회복",hugepower:"순수한힘",moxie:"자기과신",speedboost:"가속",regenerator:"재생력",adaptability:"적응력",technician:"테크니션",filter:"필터",sandforce:"모래의힘",slushrush:"눈헤치기",toughclaws:"억센발톱"};
const ABILITY_DESC={blaze:"HP가 낮으면 불 기술 위력 ↑",torrent:"HP가 낮으면 물 기술 위력 ↑",overgrow:"HP가 낮으면 풀 기술 위력 ↑",static:"맞으면 30% 확률로 상대 마비",intimidate:"등장 시 상대 공격 1 ↓",sturdy:"풀피일 때 한 방에 안 쓰러짐",thickfat:"불 기술 피해 절반",guts:"상태이상이면 공격 ↑",levitate:"땅 타입 기술 무효",poisonpoint:"맞으면 30% 확률로 상대 중독",icebody:"싸라기눈일 때 매턴 회복",flamebody:"맞으면 30% 확률로 상대 화상",roughskin:"물리 기술로 맞으면 상대도 깎인다",swiftswim:"비가 오면 속도 2배",chlorophyll:"햇살이 강하면 속도 2배",insomnia:"잠들지 않는다",immunity:"독에 걸리지 않는다",waterveil:"화상을 입지 않는다",sniper:"급소에 맞히면 위력이 더 오른다",naturalcure:"교체하면 상태이상이 낫는다",hugepower:"물리 기술 위력이 크게 오른다",moxie:"상대를 쓰러뜨리면 공격 1 ↑",speedboost:"매 턴 끝에 속도 1 ↑",regenerator:"교체로 물러나면 체력 1/3 회복",adaptability:"자속(같은 타입) 기술 위력이 더 오른다",technician:"위력 60 이하 기술 위력 ↑",filter:"효과가 굉장한 피해를 줄인다",sandforce:"모래바람일 때 바위·땅·강철 기술 위력 ↑",slushrush:"싸라기눈일 때 속도 2배",toughclaws:"물리 기술 위력이 오른다"};
...
const ABILITY_OVERRIDE={sporelet:"sturdy",gustmoth:"levitate",barkfist:"guts",zenapex:"moxie",glimmite:"levitate",lumenfae:"levitate",duskbeak:"insomnia",ravenveil:"speedboost",magmahound:"thickfat",tidewhale:"thickfat",riverdrake:"intimidate",blazelion:"intimidate",krakentide:"intimidate",grovespirit:"regenerator",shadowlord:"intimidate",dawnguard:"sturdy",voltrat:"static",harelord:"guts",jellure:"levitate",emberfly:"flamebody",pyrmoth:"flamebody",cindercat:"flamebody",lavakit:"flamebody",boulderin:"roughskin",crablord:"roughskin",hedgemoss:"roughskin",otterwave:"swiftswim",sharkfin:"swiftswim",frostfish:"swiftswim",nipling:"swiftswim",seedbean:"chlorophyll",sproutcat:"chlorophyll",palmore:"chlorophyll",leafwyrm:"chlorophyll",thunderowl:"insomnia",lunarmoth:"insomnia",swampfrog:"immunity",burrowmouse:"immunity",tidalore:"adaptability",shellow:"waterveil",stormhawk:"sniper",sandwhirl:"sandforce",sprigfawn:"naturalcure",bunnyhop:"naturalcure",dewdrop:"naturalcure",tigerflame:"hugepower",magmadon:"hugepower",
  ...
  leafdrake:"overgrow",vinesnake:"poisonpoint",petalwing:"chlorophyll",blossomhawk:"chlorophyll",bloomlynx:"chlorophyll",mossback:"sturdy",terrapin:"sturdy",titanoak:"filter",
  ...
  frostpup:"icebody",glacibear:"thickfat",snowl:"slushrush",cryogon:"icebody",iceling:"slushrush",frostwyrm:"icebody",glaciarch:"sturdy",
  drakeling:"toughclaws",wyverna:"toughclaws",skydrake:"intimidate",dawnwyrm:"sturdy",
  pebblet:"sturdy",megalith:"sturdy",burrowlord:"sandforce",dustbunny:"immunity",thumplord:"hugepower",
  // H3-9 네이티브 라인 12종 — 편중 상한(≤13) 안에서 배정: 격투=근성/급소, 악=위협(포식자), 강철=옹골참 등.
  pummelpup:"sniper",taekwarrior:"moxie",psykit:"insomnia",mystfox:"technician",pixibud:"naturalcure",blossfae:"naturalcure",
...
const EFF={
  ...
  grass:  {fire:.5,water:2, grass:.5,elec:1, normal:1,flying:.5,rock:2, ice:1, poison:.5,ground:2, dragon:.5, bug:.5,fight:1, psychic:1, fairy:1, ghost:1, dark:1, steel:.5},
  ...
  flying: {fire:1, water:1, grass:2, elec:.5,normal:1,flying:1, rock:.5,ice:1, poison:1, ground:1, dragon:1, bug:2, fight:2, psychic:1, fairy:1, ghost:1, dark:1, steel:.5},
  ...
  ground: {fire:2, water:1, grass:.5,elec:2, normal:1,flying:0, rock:2, ice:1, poison:2, ground:1, dragon:1, bug:.5,fight:1, psychic:1, fairy:1, ghost:1, dark:1, steel:2},
