...
const DEX=[
  ...
  {id:"voltbeetle",name:"찌리딱",em:"🪲",type:"elec",type2:"bug",tier:1,base:{hp:48,atk:9,def:13,spd:12,spa:13,spDef:13},moves:["tackle","spark"],learn:[[8,"doubleteam"],[10,"bugbite"],[13,"bolt"],[16,"growl"],[23,"confuse"],[31,"focusenergy"],[38,"lullaby"]],evolveTo:"thunderowl",evolveLv:22},
  ...
  {id:"lunarmoth",name:"루나비",em:"🦋",type:"poison",type2:"bug",tier:3,base:{hp:80,atk:22,def:19,spd:19,spa:16,spDef:19},moves:["gust","peck"],learn:[[8,"growl"],[14,"focusenergy"],[18,"bugbite"],[21,"confuse"],[26,"wingatk"],[27,"lullaby"],[30,"doubleteam"],[33,"recover"],[40,"swordsdance"]]},
...
{id:"crablord",name:"집게왕",em:"🦞",type:"water",type2:"rock",tier:3,base:{hp:82,atk:25,def:32,spd:11,spa:9,spDef:22},moves:["crush","rockslide","aquajet","boulder"],learn:[[8,"confuse"],[16,"focusenergy"],[23,"growl"],[31,"doubleteam"],[38,"crosschop"],[39,"swordsdance"]]},
  ...
  {id:"emberfly",name:"불티나방",em:"🔥",type:"fire",type2:"bug",tier:1,base:{hp:44,atk:12,def:10,spd:16,spa:15,spDef:11},moves:["ember","gust"],learn:[[8,"recover"],[14,"peck"],[16,"bugbite"],[18,"lullaby"],[20,"flare"],[27,"swordsdance"],[36,"doubleteam"]],evolveTo:"pyrmoth",evolveLv:30},
  ...
  {id:"thundwyrm",name:"뇌전룡",em:"⚡",type:"elec",type2:"dragon",tier:3,base:{hp:80,atk:20,def:16,spd:24,spa:26,spDef:18},moves:["thunder","twinbolt","dragonbreath","skyrush"],learn:[[8,"recover"],[18,"lullaby"],[27,"thunderwave"],[36,"swordsdance"],[42,"quickstrike"],[48,"wildbolt"]]},
  ...
  {id:"petalwing",name:"꽃날개",em:"🦋",type:"grass",type2:"bug",tier:1,base:{hp:44,atk:12,def:11,spd:18,spa:16,spDef:13},moves:["gust","leaf"],learn:[[8,"growl"],[14,"absorb"],[16,"bugbite"],[18,"doubleteam"],[20,"wingatk"],[27,"confuse"],[36,"focusenergy"]],evolveTo:"blossomhawk",evolveLv:30},
  ...
  {id:"cryogon",name:"동결룡",em:"🐋",type:"ice",type2:"dragon",tier:3,base:{hp:84,atk:24,def:28,spd:14,spa:24,spDef:22},moves:["blizzard","rockslide","icebeam","dragonbreath"],learn:[]},
  ...
  {id:"frostwyrm",name:"빙하룡",em:"❄️",type:"ice",type2:"dragon",tier:3,base:{hp:82,atk:22,def:26,spd:16,spa:26,spDef:24},moves:["blizzard","icebeam","dragonbreath","harden"],learn:[[8,"swordsdance"],[16,"lullaby"],[23,"recover"],[31,"confuse"],[34,"hailstorm"],[38,"focusenergy"]]},
  ...
  {id:"skydrake",name:"천공룡",em:"🐲",type:"dragon",type2:"flying",tier:3,base:{hp:88,atk:27,def:24,spd:24,spa:20,spDef:22},moves:["skyrush","crush","wingatk","dragonbreath"],learn:[]},
  ...
  {id:"glowfly",name:"반딧불이",em:"🪰",type:"elec",type2:"bug",tier:1,base:{hp:40,atk:10,def:10,spd:18,spa:18,spDef:12},moves:["spark","tackle"],learn:[[8,"nastyplot"],[14,"bolt"],[16,"bugbite"],[18,"agility"],[22,"confuse"],[27,"harden"],[36,"batonpass"]],evolveTo:"arcmoth",evolveLv:30},
  ...
  {id:"glaciarch",name:"빙하제",em:"🐉",type:"ice",type2:"dragon",tier:4,secret:true,legend:true,base:{hp:112,atk:33,def:37,spd:23,spa:41,spDef:35},moves:["blizzard","icebeam","dragonbreath","rockslide"],learn:[]},
  {id:"aqualord",name:"수룡왕",em:"🐉",type:"water",type2:"dragon",tier:4,secret:true,legend:true,base:{hp:112,atk:33,def:35,spd:27,spa:43,spDef:35},moves:["hydro","tsunami","dragonbreath","crush"],learn:[]},
  ...
  {id:"dawnwyrm",name:"여명룡",em:"🐉",type:"flying",type2:"dragon",tier:4,secret:true,legend:true,base:{hp:118,atk:37,def:35,spd:35,spa:37,spDef:35},moves:["skyrush","dragonbreath","crush","recover"],learn:[]},
];
