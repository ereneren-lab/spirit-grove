...
{id:"crablord",name:"집게왕",em:"🦞",type:"water",type2:"fight",tier:3,base:{hp:82,atk:25,def:32,spd:11,spa:9,spDef:22},moves:["crush","rockslide","aquajet","karatechop"],learn:[[8,"confuse"],[16,"focusenergy"],[23,"growl"],[31,"doubleteam"],[38,"closecombat"],[39,"swordsdance"],[44,"aurasphere"]]},
  ...
  {id:"snowl",name:"눈올빼",em:"🦉",type:"flying",type2:"ghost",tier:2,base:{hp:62,atk:16,def:14,spd:24,spa:20,spDef:16},moves:["peck","shadowball","gust","ominouswind"],learn:[[8,"nastyplot"],[18,"shadowsneak"],[27,"harden"],[32,"skyrush"],[36,"agility"]]},
  ...
  {id:"crystalgon",name:"결정룡",em:"💎",type:"rock",type2:"psychic",tier:3,base:{hp:74,atk:20,def:30,spd:16,spa:26,spDef:24},moves:["rockslide","psybeam","boulder","confusion"],learn:[[8,"recover"],[16,"lullaby"],[23,"psystrike"],[31,"swordsdance"],[38,"growl"],[40,"zenheadbutt"]]},
