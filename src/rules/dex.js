...
const DEX=[
  ...
  {id:"blazelion",name:"파라온",em:"🦊",type:"fire",tier:3,base:{hp:78,atk:17,def:16,spd:17,spa:24,spDef:16},moves:["flare","inferno"],learn:[[8,"focusenergy"],[16,"confuse"],[23,"growl"],[31,"doubleteam"],[36,"crush"],[38,"swordsdance"],[40,"willowisp"],[46,"flareblitz"]]},
  ...
  {id:"grovespirit",name:"새록정",em:"🌳",type:"grass",tier:3,base:{hp:84,atk:16,def:20,spd:12,spa:22,spDef:20},moves:["vine","bloom"],learn:[[8,"roar"],[18,"bloomheal"],[27,"toxic"],[36,"crush"],[37,"agility"],[40,"gigadrain"],[42,"nastyplot"],[46,"swordsdance"]]},
  ...
  {id:"hedgemoss",name:"가시몽",em:"🦔",type:"poison",type2:"grass",tier:1,base:{hp:56,atk:12,def:15,spd:8,spa:9,spDef:15},moves:["tackle","rockthrow"],learn:[[8,"harden"],[9,"poisonpowder"],[13,"rockslide"],[18,"nastyplot"],[27,"batonpass"],[36,"agility"]]},
  {id:"sprigfawn",name:"푸르사",em:"🦌",type:"grass",type2:"normal",tier:1,base:{hp:50,atk:9,def:12,spd:13,spa:13,spDef:12},moves:["tackle","leaf"],learn:[[8,"nastyplot"],[12,"vine"],[18,"harden"],[26,"batonpass"],[27,"agility"],[36,"bloomheal"]]},
  {id:"voltbeetle",name:"찌리딱",em:"🪲",type:"elec",tier:1,base:{hp:48,atk:9,def:13,spd:12,spa:13,spDef:13},moves:["tackle","spark"],learn:[[8,"doubleteam"],[13,"bolt"],[16,"growl"],[23,"confuse"],[31,"focusenergy"],[38,"lullaby"]]},
  {id:"swampfrog",name:"개굴몽",em:"🐸",type:"water",type2:"poison",tier:2,base:{hp:54,atk:10,def:13,spd:11,spa:14,spDef:13},moves:["splash","poisonjab"],learn:[[8,"lullaby"],[14,"amnesia"],[16,"sludge"],[21,"recover"],[27,"swordsdance"],[33,"doubleteam"],[40,"growl"]]},
  {id:"emberdrake",name:"마그룡",em:"🐉",type:"fire",type2:"flying",tier:2,base:{hp:60,atk:13,def:13,spd:11,spa:18,spDef:13},moves:["ember","flare"],learn:[[8,"swordsdance"],[14,"recover"],[21,"lullaby"],[24,"inferno"],[27,"confuse"],[33,"focusenergy"],[40,"doubleteam"]]},
  {id:"otterwave",name:"무라리",em:"🦦",type:"water",type2:"normal",tier:2,base:{hp:54,atk:11,def:12,spd:14,spa:15,spDef:12},moves:["splash","hydro"],learn:[[8,"lullaby"],[14,"amnesia"],[21,"recover"],[24,"tsunami"],[27,"swordsdance"],[33,"doubleteam"],[40,"growl"]]},
  {id:"vinesnake",name:"넝쿠리",em:"🐍",type:"poison",type2:"grass",tier:2,base:{hp:50,atk:12,def:10,spd:15,spa:17,spDef:10},moves:["leaf","vine"],learn:[[8,"lullaby"],[16,"recover"],[20,"toxic"],[23,"swordsdance"],[24,"bloom"],[31,"growl"],[38,"doubleteam"]]},
  ...
  {id:"stormhawk",name:"회리매",em:"🦅",type:"flying",type2:"elec",tier:3,base:{hp:62,atk:20,def:13,spd:19,spa:14,spDef:13},moves:["gust","wingatk"],learn:[[8,"thunderwave"],[14,"swordsdance"],[21,"recover"],[26,"skyrush"],[27,"lullaby"],[30,"focusenergy"],[33,"confuse"],[40,"growl"]]},
  {id:"lunarmoth",name:"루나비",em:"🦋",type:"flying",type2:"poison",tier:3,base:{hp:66,atk:18,def:16,spd:16,spa:13,spDef:16},moves:["gust","peck"],learn:[[8,"growl"],[14,"focusenergy"],[21,"confuse"],[26,"wingatk"],[27,"lullaby"],[30,"doubleteam"],[33,"recover"],[40,"swordsdance"]]},
  ...
  {id:"jellure",name:"해파리정",em:"🪼",type:"water",type2:"poison",tier:1,base:{hp:54,atk:8,def:12,spd:15,spa:20,spDef:20},moves:["splash","sludge","hydro"],learn:[[8,"roar"],[12,"poisonpowder"],[22,"tsunami"],[26,"amnesia"],[27,"toxic"]]},
  ...
  {id:"emberfly",name:"불티나방",em:"🔥",type:"fire",type2:"flying",tier:1,base:{hp:44,atk:12,def:10,spd:16,spa:15,spDef:11},moves:["ember","gust"],learn:[[8,"recover"],[14,"peck"],[18,"lullaby"],[20,"flare"],[27,"swordsdance"],[36,"doubleteam"]],evolveTo:"pyrmoth",evolveLv:30},
  {id:"pyrmoth",name:"화염나방",em:"🦋",type:"fire",type2:"flying",tier:3,base:{hp:74,atk:18,def:14,spd:22,spa:26,spDef:16},moves:["flare","wingatk","inferno","gust"],learn:[[8,"recover"],[16,"lullaby"],[23,"swordsdance"],[31,"growl"],[38,"doubleteam"],[40,"skyrush"]]},
  ...
  {id:"thundwyrm",name:"뇌전룡",em:"⚡",type:"elec",type2:"flying",tier:3,base:{hp:80,atk:20,def:16,spd:24,spa:26,spDef:18},moves:["thunder","skyrush","twinbolt","crush"],learn:[[8,"recover"],[18,"lullaby"],[27,"thunderwave"],[36,"swordsdance"],[42,"quickstrike"],[48,"wildbolt"]]},
  ...
  {id:"glacibear",name:"빙하곰",em:"🐻‍❄️",type:"ice",type2:"rock",tier:3,base:{hp:90,atk:24,def:24,spd:10,spa:16,spDef:22},moves:["crush","icebeam","rockslide","boulder"],learn:[[8,"recover"],[16,"lullaby"],[23,"swordsdance"],[31,"hailstorm"],[38,"blizzard"],[39,"growl"]]},
  {id:"dewdrop",name:"이슬방울",em:"💧",type:"water",tier:1,base:{hp:45,atk:9,def:11,spd:13,spa:14,spDef:12},moves:["tackle","splash"],learn:[[8,"roar"],[10,"hydro"],[16,"absorb"],[18,"toxic"],[27,"nastyplot"],[36,"batonpass"]],evolveBranch:[{to:"glimmertide",lv:24,time:"day"},{to:"moonytide",lv:24,time:"night"}]},
  ...
  {id:"petalwing",name:"꽃날개",em:"🦋",type:"grass",type2:"flying",tier:1,base:{hp:44,atk:12,def:11,spd:18,spa:16,spDef:13},moves:["gust","leaf"],learn:[[8,"growl"],[14,"absorb"],[18,"doubleteam"],[20,"wingatk"],[27,"confuse"],[36,"focusenergy"]],evolveTo:"blossomhawk",evolveLv:30},
  ...
  {id:"frostwyrm",name:"빙하룡",em:"❄️",type:"ice",tier:3,base:{hp:82,atk:22,def:26,spd:16,spa:26,spDef:24},moves:["blizzard","icebeam","crush","harden"],learn:[[8,"swordsdance"],[16,"lullaby"],[23,"recover"],[31,"confuse"],[34,"hailstorm"],[38,"focusenergy"]]},
  {id:"drakeling",name:"새끼용",em:"🦎",type:"normal",tier:1,base:{hp:50,atk:16,def:14,spd:14,spa:12,spDef:12},moves:["tackle","headbutt"],learn:[[8,"agility"],[16,"crush"],[18,"batonpass"],[22,"slam"],[27,"harden"],[36,"nastyplot"]],evolveTo:"wyverna",evolveLv:25},
  {id:"wyverna",name:"비룡",em:"🐉",type:"normal",tier:2,base:{hp:70,atk:22,def:20,spd:18,spa:16,spDef:16},moves:["crush","headbutt","slam","furyswipe"],learn:[[8,"roar"],[18,"toxic"],[27,"nastyplot"],[36,"gust"],[37,"agility"]],evolveTo:"skydrake",evolveLv:42},
  ...
  {id:"glowfly",name:"반딧불이",em:"🪰",type:"elec",tier:1,base:{hp:40,atk:10,def:10,spd:18,spa:18,spDef:12},moves:["spark","tackle"],learn:[[8,"nastyplot"],[14,"bolt"],[18,"agility"],[22,"confuse"],[27,"harden"],[36,"batonpass"]],evolveTo:"arcmoth",evolveLv:30},
