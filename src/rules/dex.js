...
const DEX=[
  ...
  {id:"voltbeetle",name:"찌리딱",em:"🪲",type:"elec",tier:1,base:{hp:48,atk:9,def:13,spd:12,spa:13,spDef:13},moves:["tackle","spark"],learn:[[8,"doubleteam"],[13,"bolt"],[16,"growl"],[23,"confuse"],[31,"focusenergy"],[38,"lullaby"]],evolveTo:"thunderowl",evolveLv:22},
  ...
  {id:"vinesnake",name:"넝쿠리",em:"🐍",type:"poison",type2:"grass",tier:2,base:{hp:63,atk:15,def:12,spd:19,spa:21,spDef:12},moves:["leaf","vine"],learn:[[8,"lullaby"],[16,"recover"],[20,"toxic"],[23,"swordsdance"],[24,"bloom"],[31,"growl"],[38,"doubleteam"]]},
